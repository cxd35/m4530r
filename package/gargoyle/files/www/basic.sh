...
<form>
	<fieldset id="config_fieldset">
		...
		<div class='indent'>
			<input type="radio" id="global_gateway" name="global_configuration" value="gateway" onclick="setBridgeVisibility()" >网关 (默认)</input>
			<br/>
			<input type="radio" id="global_bridge" name="global_configuration" value="bridge" onclick="setBridgeVisibility()" >无线桥接/中继</input>
		</div>
	</fieldset>
